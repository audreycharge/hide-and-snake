...
void updateMiniGame(){
 ...
 void drawMiniGame() {
    ...
    if (bit) {
        shadowOAM[16].attr0 = (1<<14) | 56;
        shadowOAM[16].attr1 = (3<<14) | 88;
        shadowOAM[16].attr2 = ((26)*32+(12)) | ((5)<<12);
    } else if (caught) {
        shadowOAM[17].attr0 = (0<<14) | 48;
        shadowOAM[17].attr1 = (3<<14) | 88;
        shadowOAM[17].attr2 = ((18)*32+(20)) | ((5)<<12);
    } else {
        drawHand();
        drawHead();
    }
...
void initHand() {
    ...
    hand.width = 32;
    hand.height = 32;
    hand.row = 160 / 2 - hand.height / 2;
    hand.col = 240 / 2 - hand.width / 2;
...
void drawHand() {
    shadowOAM[14].attr0 = (0<<14) | hand.row;
    shadowOAM[14].attr1 = (2<<14) | hand.col;
    if (!dodge) {
        shadowOAM[14].attr2 = ((18)*32+(12)) | ((5)<<12);
    } else {
        shadowOAM[14].attr2 = ((18)*32+(16)) | ((5)<<12);
    }
}
...
void updateHead(){
    ...
    if (!strike) {
        head.col = 240 / 4 * 3 - head.width / 2;
    } else {
        head.col = 240 / 2 - head.width / 2;
    }
}

void drawHead() {
    shadowOAM[15].attr0 = (0<<14) | head.row;
    shadowOAM[15].attr1 = (2<<14) | head.col;
    if (!strike) {
        shadowOAM[15].attr2 = ((22)*32+(12)) | ((5)<<12);
    } else {
        shadowOAM[15].attr2 = ((22)*32+(16)) | ((5)<<12);
    }
}
