...
# 1 "instructions2.h" 1
# 22 "instructions2.h"
extern const unsigned short instructions2Tiles[9632];
...
# 1 "pause.h" 1
# 22 "pause.h"
extern const unsigned short pauseTiles[5152];
...
# 1 "win.h" 1
# 22 "win.h"
extern const unsigned short winTiles[6208];
...
extern const unsigned int fightSong_sampleRate;
extern const unsigned int fightSong_length;
extern const signed char fightSong_data[];
# 24 "main.c" 2
# 1 "bg2.h" 1
# 22 "bg2.h"
...
void initialize()
{
    (*(volatile unsigned short *)0x4000000) = 0| (1<<9) | (1<<12) | (1<<8) | (1<<10);
...
void start() {
    (*(volatile unsigned short*)0x4000008) = ((2)<<2) | ((28)<<8) | (0<<14) | (1<<7);
    (*(volatile unsigned short*)0x400000A) = ((0)<<2) | ((30)<<8) | (1<<14) | (1<<7);

    DMANow(3, startPal, ((unsigned short *)0x5000000), 512 /2);
    DMANow(3, startTiles, &((charblock *)0x6000000)[2], 9216 / 2);
...
void goToInstructions() {
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[2], 7424 / 2);
...
void instr() {
    if ((!(~(oldButtons)&((1<<8))) && (~buttons & ((1<<8))))) {
        ...
        DMANow(3, instructions2Tiles, &((charblock *)0x6000000)[2], 19264 / 2);
...
void goToGame() {
    ...
    (*(volatile unsigned short *)0x4000000) = 0 | (1<<9) | (1<<12) | (1<<10);

    DMANow(3, forestPal, ((unsigned short *)0x5000000), 512 /2);
    DMANow(3, forestTiles, &((charblock *)0x6000000)[0], 26176 / 2);
    DMANow(3, forestMap, &((screenblock *)0x6000000)[30], 4096 / 2);

    DMANow(3, bg2Tiles, &((charblock *)0x6000000)[3], 7424 / 2);
    DMANow(3, bg2Map, &((screenblock *)0x6000000)[20], 4096 / 2);

    (*(volatile unsigned short*)0x400000A) = ((0)<<2) | ((30)<<8) | (1<<14) | (1<<7);
    (*(volatile unsigned short*)0x400000C) = ((3)<<2) | ((20)<<8) | (1<<14) | (1<<7);
...
void goToFight(){
    ...
    DMANow(3, snaketimePal, ((unsigned short *)0x5000000), 512 /2);
    DMANow(3, snaketimeTiles, &((charblock *)0x6000000)[2], 11776 / 2);
    DMANow(3, snaketimeMap, &((screenblock *)0x6000000)[28], 2048 / 2);
    (*(volatile unsigned short*)0x4000008) = ((2)<<2) | ((28)<<8) | (0<<14) | (1<<7);
    waitForVBlank();
    initMiniGame();
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 128 * 4);
...
void pause(){
    ...
    DMANow(3, pauseTiles, &((charblock *)0x6000000)[2], 10304 / 2);
...
void win(){
    ...
    DMANow(3, winTiles, &((charblock *)0x6000000)[2], 12416 / 2);
...
void lose(){
    DMANow(3, gameoverPal, ((unsigned short *)0x5000000), 512 /2);
    DMANow(3, gameoverTiles, &((charblock *)0x6000000)[2], 11136 / 2);
